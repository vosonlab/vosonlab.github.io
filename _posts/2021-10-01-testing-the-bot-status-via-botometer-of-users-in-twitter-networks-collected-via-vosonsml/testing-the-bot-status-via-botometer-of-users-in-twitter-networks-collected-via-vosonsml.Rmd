...
As social media platforms like Twitter become important spaces for information diffusion, discussion and opinion formation, serious concerns have been raised about the role of malicious *socialbots* in manipulating and influencing public opinion [see @RizoiuEtal2018]. While there are many types of *socialbots*, malicious accounts aim to interfere with and even manipulate ongoing communication and opinion formation [@BadawyEtal2018]. Their detection and the understanding of consequent dynamics of behaviour are relevant to researchers and it is central to the research collaboration the VOSON Lab is involved in [see @Volkswagen2020]. 

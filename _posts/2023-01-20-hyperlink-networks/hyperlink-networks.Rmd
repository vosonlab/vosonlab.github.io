...
### 3.1.1 Merging the "www" subdomain into a canonical domain
...
### 3.2.1 Creatng the network containing just the seed sites
...
### 3.2.2 Creatng the network containing the seeds plus "important" non-seed sites
...
### 3.2.3 Manually pruning irrelevant sites
